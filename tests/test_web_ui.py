...
class WebUiTests(unittest.TestCase):
    ...
    def test_homepage_includes_demo_fill_buttons(self):
        ...
        self.assertIn("加载 Spikex Profile", body)
        self.assertIn("fillProfile('spikex_brazil')", body)
        self.assertIn("Spikex Brazil Demo", body)
        self.assertIn("测试风险阻断", body)
        self.assertIn("清空表单", body)
    ...
    def test_homepage_includes_sidebar_app_shell_navigation(self):
        _status, _headers, body = self.app.handle("GET", "/")
        ...
        self.assertIn("Creative Operations", body)
        self.assertIn("工作台", body)
        self.assertIn("素材生成", body)
        self.assertIn('href="/"', body)
        self.assertIn("生成记录", body)
        self.assertIn('href="/history"', body)
        self.assertIn("数据分析", body)
        self.assertIn('href="/performance"', body)
        self.assertIn("复盘报告", body)
        self.assertIn('href="/performance/history"', body)
        self.assertIn("操作指南", body)
        self.assertIn("验收清单", body)
        self.assertNotIn("Internal Workflow Navigation", body)

    def test_homepage_includes_workflow_overview_and_grouped_form(self):
        _status, _headers, body = self.app.handle("GET", "/")

        self.assertIn("Workflow Overview", body)
        self.assertIn("生成素材", body)
        self.assertIn("准备上线", body)
        self.assertIn("分析表现", body)
        self.assertIn("下一轮迭代", body)
        self.assertIn("Quick Actions", body)
        self.assertIn("生成表单", body)
        self.assertIn("基础信息", body)
        self.assertIn("市场与受众", body)
        self.assertIn("产品信息", body)
        self.assertIn("合规要求", body)
        self.assertIn("生成要求", body)
        self.assertIn("sticky-summary", body)
        self.assertIn("开始生成素材", body)
        self.assertNotIn("行业 industry", body)
        self.assertNotIn("产品 product", body)
        self.assertNotIn("平台 platform", body)
    ...
    def test_performance_history_detail_shows_next_round_recommendations(self):
        ...
        self.assertIn("建议放量", body)
        self.assertIn("继续测试", body)
        self.assertIn("需要重剪", body)
        self.assertIn("Copy / CTA Tests", body)
        self.assertIn("检查落地页", body)
        self.assertIn("暂停", body)
    ...
    def test_performance_history_detail_shows_next_round_brief_request(self):
        ...
        self.assertIn("Copy Request", body)
...
"""
    ...
    def test_homepage_renders_copyable_creative_brief_markdown_for_generated_results(self):
        ...
        self.assertIn("Creative Brief", generated_segment)
    ...
    def test_history_page_exists_and_lists_generated_records(self):
        ...
        self.assertIn("history-list", body)
        self.assertIn("data-table", body)
        self.assertIn("素材数量", body)
        self.assertNotIn("generation_id:", body)
        self.assertNotIn("created_at:", body)
        self.assertNotIn("is BLOCKED:", body)
    ...
    def test_history_detail_generated_shows_creative_brief_and_copy(self):
        ...
        self.assertIn("creative count", body)
    ...
    def test_profile_generated_output_preserves_history_and_product_facts_in_brief(self):
        ...
        self.assertEqual(status, 200)
        self.assertIn("Creative Brief", detail_body)
