...
class CliTests(unittest.TestCase):
    def test_cli_outputs_generation_payload_for_valid_request(self):
        ...
        self.assertIn("campaign_summary", payload["素材内容"])
        self.assertEqual(len(payload["素材内容"]["video_ad_concepts"]), 5)
        self.assertIn("Check", payload["素材内容"]["video_ad_concepts"][0]["hook"])
    ...
    def test_cli_outputs_block_reason_without_generation_when_redline_hit(self):
        ...
        self.assertIn("替代表达建议", payload["红线审核结果"])
